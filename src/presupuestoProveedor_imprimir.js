...
const imprimir = async (req, res) => {
  try {
    ...
    doc.font("Helvetica-Bold")
      .fontSize(20)
      .text("Presupuesto Proveedor", 50, 50, { align: "center" });
...
// ---------------- Datos del presupuesto, cliente y empleado ----------------
    ...
    const cDatosProveedor = [
      ["Código:", presupuesto.proveedor?._id || "N/A"],
      ["Nombre:", presupuesto.proveedor?.name || "N/A"],
      ["CUIT:", presupuesto.proveedor?.cuit || "N/A"],
      ["Email:", presupuesto.proveedor?.email || "N/A"],
      ["Teléfono:", presupuesto.proveedor?.telefono || "N/A"],
      ["País:", presupuesto.proveedor?.pais?.name || "N/A"],
      ["Provincia:", presupuesto.proveedor?.provincia?.name || "N/A"],
      ["Localidad:", presupuesto.proveedor?.localidad?.name || "N/A"],
      ["Barrio:", presupuesto.proveedor?.barrio?.name || "N/A"],
      ["Calle:", presupuesto.proveedor?.calle?.name || "N/A"],
      ["Altura:", presupuesto.proveedor?.altura || "N/A"],
      ["Cond. IVA:", presupuesto.proveedor?.condicionIva?.name || "N/A"],
    ];
